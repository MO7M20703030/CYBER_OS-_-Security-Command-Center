...
Total Threat analysis with growth indicators.

System Health and Uplink Cipher (AES-256-GCM) status monitoring.

Live Alert Feed with severity-based categorization (Critical, Warning, Info).

Deep Packet Inspection Logs: A detailed, responsive data table showing source IPs, protocols, and enforcement actions (Blocked, Allowed, Quarantined).
...
JavaScript (ES6+) (Dynamic UI interactions and data logic)

Chart.js (Threat radar visualization)
